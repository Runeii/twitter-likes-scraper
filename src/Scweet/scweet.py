...
from utils import init_driver, log_in, get_last_date_from_csv, log_search_page, keep_scroling, dowload_images

from const import get_email, get_password, get_username
save_dir = 'output'
save_images_dir = save_dir + "/images"
...
def scrape(since, until=None, words=None, to_account=None, from_account=None, mention_account=None, interval=5, lang=None,
          ...
          show_images=False, save_images=True,  filter_replies=False, proximity=False, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--from_account', type=str,
                        help='Tweets from this account (example : @Tesla).', default=None, required=True)
    ...
    parser.add_argument('--until', type=str,
                        help='Max date for search query. example : %%Y-%%m-%%d.', default='2022-11-19', required=False)
